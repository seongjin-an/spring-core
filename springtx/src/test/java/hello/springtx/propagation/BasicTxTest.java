...
//        }
    ...
    @DisplayName("외부 트랜잭션과 내부 트랜잭션을 완전히 분리해서 사용")
    @Test
    public void inner_rollback_requires_new() throws Exception{
        ...
        definition.setPropagationBehavior(TransactionDefinition.PROPAGATION_REQUIRES_NEW); // 물리적으로 새로운 트랜잭션을 만든다.
